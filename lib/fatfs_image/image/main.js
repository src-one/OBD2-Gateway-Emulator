...
linkSlider('engine_load', 'current-engine_load', debounce(bind_trailing_args(updateOBDValue, 'engine_load'), 100));

linkSlider('engine_coolant', 'current-engine_coolant', debounce(bind_trailing_args(updateOBDValue, 'engine_coolant'), 100));
linkSlider('engine_oil', 'current-engine_oil', debounce(bind_trailing_args(updateOBDValue, 'engine_oil'), 100));

linkSlider('engine_demand_torque', 'current-engine_demand_torque', debounce(bind_trailing_args(updateOBDValue, 'engine_demand_torque'), 100));
linkSlider('engine_actual_torque', 'current-engine_actual_torque', debounce(bind_trailing_args(updateOBDValue, 'engine_actual_torque'), 100));
linkSlider('engine_reference_torque', 'current-engine_reference_torque', debounce(bind_trailing_args(updateOBDValue, 'engine_reference_torque'), 100));
linkSlider('engine_percent_torque', 'current-engine_percent_torque', debounce(bind_trailing_args(updateOBDValue, 'engine_percent_torque'), 100));