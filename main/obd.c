...
int obdRevConvert_5C(float val, unsigned int *A, unsigned int *B, unsigned int *C, unsigned int *D)
{
    *A = (unsigned int)(val + 40);
    return 1;
}

int obdRevConvert_61(float val, unsigned int *A, unsigned int *B, unsigned int *C, unsigned int *D)
{
    *A = (unsigned int)(val + 125);
    return 1;
}

int obdRevConvert_62(float val, unsigned int *A, unsigned int *B, unsigned int *C, unsigned int *D)
{
    *A = (unsigned int)(val + 125);
    return 1;
}

int obdRevConvert_63(float val, unsigned int *A, unsigned int *B, unsigned int *C, unsigned int *D)
{
    *A = (unsigned int)((long)val / 256);
    *B = (unsigned int)((long)val % 256);
    return 2;
...
int obdRevConvert_64(float val, unsigned int *A, unsigned int *B, unsigned int *C, unsigned int *D, unsigned int *E)
{
    *A = (unsigned int)(val + 125);
    *B = (unsigned int)(val + 125);
    *C = (unsigned int)(val + 125);
    *D = (unsigned int)(val + 125);
    *E = (unsigned int)(val + 125);
    return 2;
}